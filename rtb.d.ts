...
declare module SDK {
	interface Root {
		...
		// clientId needs to use for working with widgets' metadata
	...
	interface IShapeWidget extends IWidget {
		...
		style: {
			...
			textAlignVertical: TextAlignVertical | TextAlignVerticalStyle
			highlighting: HighlightingStyle
			italic: ItalicStyle
			strike: StrikeStyle
			underline: UnderlineStyle
	...
	/**
	 * @deprecated use enums.ShapeType
	 */
	type BorderStyleStyle = number
	/**
	 * @deprecated use enums.FontFamily
	 */
	type FontFamilyStyle = number
	/**
	 * @deprecated use enums.TextAlign
	 */
	type TextAlignStyle = 'l' | 'c' | 'r' //left | center | right
	/**
	 * @deprecated use enums.TextAlignVertical
	 */
	type TextAlignVerticalStyle = 't' | 'm' | 'b' //top | middle | bottom
	/**
	 * @deprecated use enums.LineStyle
	 */
	type LineStyleStyle = number
	/**
	 * @deprecated use enums.LineType
	 */
	type LineTypeStyle = number
	/**
	 * @deprecated use enums.LineArrowheadStyle
	 */
